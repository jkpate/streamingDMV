...
class FiveValenceParameters(
  ...
  def possibleStopEvents( h:Int ) = {
    Seq(
      StopEvent( h, LeftAtt, FourDependentValence, Stop ),
      StopEvent( h, LeftAtt, FourDependentValence, NotStop ),
      ...
      StopEvent( h, RightAtt, FourDependentValence, Stop ),
      StopEvent( h, RightAtt, FourDependentValence, NotStop ),
